...
#define PIOS_COM_BRIDGE_RX_BUF_LEN       300
#define PIOS_COM_BRIDGE_TX_BUF_LEN       300
...
#define PIOS_COM_MAVLINK_TX_BUF_LEN      512
#define PIOS_COM_MAVLINK_RX_BUF_LEN      512
...
void PIOS_Board_Init(void)
{
    ...
    case HWSETTINGS_SPK2_FLEXIPORT_MAVLINK:
        PIOS_Board_configure_com(&pios_usart_flexi_cfg, PIOS_COM_MAVLINK_RX_BUF_LEN, PIOS_COM_MAVLINK_TX_BUF_LEN, &pios_usart_com_driver, &pios_com_mavlink_id);
        break;
    ...
    case HWSETTINGS_SPK2_MAINPORT_MAVLINK:
        PIOS_Board_configure_com(&pios_usart_main_cfg, PIOS_COM_MAVLINK_RX_BUF_LEN, PIOS_COM_MAVLINK_TX_BUF_LEN, &pios_usart_com_driver, &pios_com_mavlink_id);
        break;
